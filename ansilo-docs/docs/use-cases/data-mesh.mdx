...
<center>
  <Diagram maxHeight="200px" width="70%" height="auto" class="auto-invert" />
</center>
...
Each product can be queried or ingested using the workbench interface with SQL.
...
regardless of the underlying data store. This provides a unified interface into all data stores through a consistent
SQL interface.
