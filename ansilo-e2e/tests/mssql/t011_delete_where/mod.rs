    ...
    assert_eq!(
        ...
        vec![
            ...
            (
                ...
                LoggedQuery::new(
                    [
                        r#"DELETE FROM [dbo].[t011__test_tab] "#,
    ...
    assert_eq!(
        ...
        vec![
            ...
            (
                ...
                LoggedQuery::new(
                    [
                        r#"DELETE FROM [dbo].[t011__test_tab_no_pk] "#,
...
fn test_delete_where_local() {
    ...
    // Delete with local eval should lock remote rows using WITH (UPDLOCK) first
    assert_eq!(
        query_log,
        vec![
            ("mssql".to_string(), LoggedQuery::new_query("BEGIN")),
            (
                ...
                LoggedQuery::new(
                    [
                        ...
                        r#"FROM [dbo].[t011__test_tab] AS [t1] "#,
                        r#"WITH (UPDLOCK)"#,
                    ]
                    .join(""),
                    vec![],
