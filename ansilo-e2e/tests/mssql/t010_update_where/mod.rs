    ...
    assert_eq!(
        ...
        vec![
            ...
            (
                ...
                LoggedQuery::new(
                    [
                        r#"UPDATE [dbo].[t010__test_tab] SET [name] = ? "#,
...
fn test_update_where_local() {
    ...
    // Update with local eval should lock remote rows using WITH (UPDLOCK) first
    assert_eq!(
        query_log,
        vec![
            ("mssql".to_string(), LoggedQuery::new_query("BEGIN")),
            (
                ...
                LoggedQuery::new(
                    [
                        ...
                        r#"FROM [dbo].[t010__test_tab] AS [t1] "#,
                        r#"WITH (UPDLOCK)"#,
                    ]
                    .join(""),
                    vec![],
            ...
            (
                ...
                LoggedQuery::new(
                    ...
                    .join(""),
                    vec![
                        "LoggedParam [index=1, method=setNString, value=Johnny]".into(),
    ...
    assert_eq!(
        ...
        vec![
            ...
            (
                ...
                LoggedQuery::new(
                    [
                        r#"UPDATE [dbo].[t010__test_tab_no_pk] SET [name] = ? "#,
