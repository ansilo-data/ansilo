...
use ansilo_connectors_native_mongodb::{
    MongodbEntitySearcher, MongodbEntitySourceConfig, MongodbCollectionOptions,
};
use ansilo_core::{
...
#[test]
#[serial]
fn test_mongodb_discover_entities_default() {
    ansilo_logging::init_for_tests();
    let mut con = common::connect_to_mongodb();
    ...
    assert_eq!(
        ...
        "mongodb should return no tables on empty db"
    );
}

#[test]
#[serial]
fn test_mongodb_discover_entities_with_filter_wildcard() {
    ansilo_logging::init_for_tests();
    let mut con = common::connect_to_mongodb();
...
#[test]
#[serial]
fn test_mongodb_discover_entities_varchar_type_mapping() {
    let mut con = common::connect_to_mongodb();
    ...
    assert_eq!(
        ...
        EntityConfig::minimal(
            ...
            EntitySourceConfig::from(MongodbEntitySourceConfig::Collection(MongodbCollectionOptions::new(
...
#[test]
#[serial]
fn test_mongodb_discover_entities_number_type_mapping() {
    let mut con = common::connect_to_mongodb();
