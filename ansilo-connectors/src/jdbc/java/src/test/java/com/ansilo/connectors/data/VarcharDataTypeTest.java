...
public class VarcharDataTypeTest extends DataTypeTest {
    private VarcharDataType dataType;

    @BeforeEach
    void setUp() {
        super.setUp();
        this.dataType = new VarcharDataType();
    }

    @Test
    void testHandlesNullValue() throws Exception {
        when(this.resultSet.getString(0)).thenReturn(null);
    ...
    void testEmptyString() throws Exception {
        when(this.resultSet.getString(0)).thenReturn("");
    ...
    void testString() throws Exception {
        when(this.resultSet.getString(0)).thenReturn("abc");
